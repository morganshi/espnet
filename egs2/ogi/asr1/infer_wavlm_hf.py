...
model_name = "/data/mohan/workdir/espnet/egs2/ogi/asr2/exp/wavlm-large-ogi-fullfinetune"
processor = Wav2Vec2Processor.from_pretrained(model_name)
model = WavLMForCTC.from_pretrained("/data/mohan/workdir/espnet/egs2/ogi/asr2/exp/wavlm-large-ogi-fullfinetune")

device = "cuda" if torch.cuda.is_available() else "cpu"
model.to(device)
model.eval()

wav_scp_path = "/data/mohan/workdir/espnet/egs2/ogi/asr1/dump/raw/test/wav.scp"
wav_dict = {}
...
normalize_file = os.path.join("/data/mohan/workdir/espnet/egs2/ogi/asr2/exp/wavlm-large-ogi-fullfinetune/", "normalizer.json")
...
# 保存转录结果到 hyp.trn
hyp_trn_path = "/data/mohan/workdir/espnet/egs2/ogi/asr1/wavlm_hf_infer_results/test/text_hyp"
...
ref_trn_path = "/data/mohan/workdir/espnet/egs2/ogi/asr1/dump/raw/test/text"
