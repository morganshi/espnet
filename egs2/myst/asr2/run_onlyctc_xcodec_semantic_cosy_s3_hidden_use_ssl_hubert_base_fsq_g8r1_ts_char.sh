...
src_lang=xcodec_semantic_cosy_s3_hidden_use_ssl_hubert_base_fsq_g8r1
tgt_lang=en
...
dir="${base_dir}/xcodec_semantic_cosy_s3_hidden_use_ssl_hubert_base_fsq_g8r1"
...
./asr2_codec.sh \
    ...
    --test_speech_token_scp ${dir}/dev/speech_token.scp    \
