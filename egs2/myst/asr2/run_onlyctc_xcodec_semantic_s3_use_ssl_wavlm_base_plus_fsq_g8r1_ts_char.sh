...
src_lang=xcodec_semantic_s3_use_ssl_wavlm_base_plus_fsq_g8r1
tgt_lang=en
...
dir="${base_dir}/xcodec_semantic_s3_use_ssl_wavlm_base_plus_fsq_g8r1"
...
./asr2_codec.sh \
    ...
    --src_token_size 1000   \
    --src_codebook_size 8   \
    --train_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_semantic_s3_use_ssl_wavlm_base_plus_fsq_g8r1/train/speech_token.scp    \
    --valid_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_semantic_s3_use_ssl_wavlm_base_plus_fsq_g8r1/dev/speech_token.scp    \
