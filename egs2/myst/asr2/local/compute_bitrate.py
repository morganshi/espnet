...
<<<<<<< HEAD
    token_shape_file=open("/data/mohan/workdir/espnet/egs2/myst/asr2/exp/asr_stats_raw_ts_fsq_bpe6000_bpe5000/train/src_text_shape",'r')
=======
...
<<<<<<< HEAD
    bitrate = float(total_token_len*np.log2(6000)) / (float(total_frame_len)/float(sample_rate))
=======
