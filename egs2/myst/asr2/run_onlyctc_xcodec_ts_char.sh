...
asr_config=conf/train_discrete_asr_int_e_branchformer1_1gpu_lr2e-3.yaml
...
./asr2_codec.sh \
    --stage 13   \
    --stop_stage 13  \
    --src_token_size 15360   \
    --src_codebook_size 1   \
    --train_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_fsq_15360/train/speech_token.scp    \
    --valid_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_fsq_15360/dev/speech_token.scp    \
