...
src_lang=xcodec_wavlm_base_plus_fsq_g8r1
tgt_lang=en
...
# 定义目录
base_dir="codec_infer_data"
dir="${base_dir}/xcodec_wavlm_base_plus_fsq_g8r1"
...
./asr2_codec.sh \
    ...
    --src_token_size 1000   \
    --src_codebook_size 8   \
    --train_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_wavlm_base_plus_fsq_g8r1/train/speech_token.scp    \
    --valid_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_wavlm_base_plus_fsq_g8r1/dev/speech_token.scp    \
    --test_speech_token_scp /data/mohan/workdir/espnet/egs2/myst/asr2/codec_infer_data/xcodec_wavlm_base_plus_fsq_g8r1/dev/speech_token.scp    \
    ...
    --test_text_scp /data/mohan/workdir/espnet/egs2/myst/asr2/dump/raw/dev/text.ts.en    \
    --src_codebook_paths "${src_codebook_paths}"  \
