...
class ESPnetKMFSQModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Encoder
        encoder_out, encoder_out_lens = self.encode(speech, speech_lengths, km_id, km_id_lengths)
    ...
    def encode(
        self, speech: torch.Tensor, speech_lengths: torch.Tensor, km_id: torch.Tensor, km_id_lengths: torch.Tensor
        ...
        with autocast(False):
            # 1. Extract feats
            feats, feats_lengths = self._extract_feats(speech, speech_lengths, km_id, km_id_lengths)
    ...
    def _extract_feats(
        ...
        if self.frontend is not None:
            ...
            feats, feats_lengths = self.frontend(speech, speech_lengths, km_id, km_id_lengths)
        else:
