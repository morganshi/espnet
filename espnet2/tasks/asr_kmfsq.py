...
from espnet2.asr.espnet_kmfsq_model import ESPnetKMFSQModel
...
from espnet2.asr.frontend.hf_kmattfsq_train import HfCTCKMATTFSQFrontend
...
frontend_choices = ClassChoices(
    ...
    classes=dict(
        ...
        hf_train_kmfsq_ctc=HfCTCKMFSQFrontend,
        hf_train_kmattfsq_ctc=HfCTCKMATTFSQFrontend,
...
class ASRTask(AbsTask):
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetKMFSQModel:
