...
from espnet2.asr.discrete_asr_codec_espnet_model import ESPnetDiscreteASRModel
...
class MTTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetMTModel:
        ...
        # 1. frontend
        if args.src_codebook_paths is not []:
        ...
        model = model_class(
            vocab_size=vocab_size,
            src_vocab_size=args.src_token_size,
