...
from espnet2.asr.discrete_asr_int_espnet_model import ESPnetDiscreteASRModel
...
from espnet2.mt.frontend.codebook_embedding import CodebookEmbedding
...
class MTTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetMTModel:
        ...
        # 1. frontend
        if args.src_token_size is not None:
            # Extract features in the model
            frontend_class = frontend_choices.get_class(args.frontend)
            frontend = frontend_class(input_size=args.src_token_size+1, **args.frontend_conf)
        ...
        model = model_class(
            vocab_size=vocab_size,
            src_vocab_size=args.src_token_size+1,
            src_codebook_size=args.src_codebook_size,
            frontend=frontend,
